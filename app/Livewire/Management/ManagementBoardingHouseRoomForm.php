...
class ManagementBoardingHouseRoomForm extends Component
{
    use WithFileUploads;
    ...
    {
        return $this->redirect('/management/boarding-houses/' . $this->id . '/rooms', navigate: true);
    }
    ...
    public function render()
    {
        ...
        return view('livewire.management.management-boarding-house-room-form', [
            'statuses'              => $statuses,
            'roomTypes'             => $roomTypes,
            'amenities'             => $amenities,
